...
[![GitHub release](https://img.shields.io/github/v/release/littlecookie0722/wairc-2026)](https://github.com/littlecookie0722/wairc-2026/releases/tag/v0.6.0)
...
The latest public release is [v0.6.0](https://github.com/littlecookie0722/wairc-2026/releases/tag/v0.6.0).
...
- [Redistributable benchmark fixture](tests/fixtures/benchmark/synthetic_iq_v1.json):
  repository-authored parameter manifest without raw recordings or model data.
- [CPU compatibility probe](docs/reproducibility.md): data-free public-transform
  and CPU-model checks across the supported Python matrix.
- [Reproducibility](docs/reproducibility.md): current limits and required records.
- [Release checklist](docs/release-checklist.md): the v0.6.0 release record and
