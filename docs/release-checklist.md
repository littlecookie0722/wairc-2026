...
This document records the `v0.8.0`, `v0.7.0`, `v0.6.0`, `v0.5.0`, `v0.4.0`, `v0.3.0`, and `v0.2.0` release gates. A
...
- [ ] Source and wheel distributions build successfully, include the v0.8.0
...
- [ ] `pyproject.toml`, `src/__init__.py`, and `CITATION.cff` use `0.8.0`.
...
- [ ] README and `ROADMAP.md` release text and links are prepared for
  `v0.8.0` publication.
- [ ] Annotated tag `v0.8.0` points to the verified release commit.
- [ ] GitHub release `v0.8.0` is published with verified notes, wheel/sdist
