...
| wairc_rf/ | Stable public transform, label, RF sample, and synthetic/competition dataset-adapter imports over compatible legacy implementations | `stft-v1` behavior, label helpers, and dataset sample contracts |
